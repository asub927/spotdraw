...
@MainActor internal final class HotkeyManager {
    ...
    nonisolated(unsafe) var isRecordingSuppressed: Bool = false
    ...
    var passthroughModifier: PassthroughModifier = .rightOption
    ...
    func installPassthroughMonitor() {
    ...
    func teardownPassthroughMonitor() {
