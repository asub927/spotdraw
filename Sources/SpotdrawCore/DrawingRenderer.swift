...
public struct DrawingRenderer {
    ...
    public static func drawStroke(points: [CGPoint], color: NSColor, lineWidth: CGFloat, alpha: CGFloat, in context: CGContext) {
    ...
    public static func drawArrow(from start: CGPoint, to end: CGPoint, color: NSColor, lineWidth: CGFloat, in context: CGContext) {
        context.saveGState()
        context.setStrokeColor(color.cgColor)
        context.setLineWidth(lineWidth)
        context.setLineCap(.round)
    ...
    public static func drawRectangle(_ rect: CGRect, color: NSColor, lineWidth: CGFloat, in context: CGContext) {
        context.saveGState()
        context.setStrokeColor(color.cgColor)
        context.setLineWidth(lineWidth)
        context.stroke(rect)
    ...
    public static func drawCircle(in rect: CGRect, color: NSColor, lineWidth: CGFloat, in context: CGContext) {
        context.saveGState()
        context.setStrokeColor(color.cgColor)
        context.setLineWidth(lineWidth)
    ...
    public static func drawLine(from start: CGPoint, to end: CGPoint, color: NSColor, lineWidth: CGFloat, in context: CGContext) {
        context.saveGState()
        context.setStrokeColor(color.cgColor)
        context.setLineWidth(lineWidth)
        context.setLineCap(.round)
    ...
    public static func drawArrowhead(from start: CGPoint, to end: CGPoint, color: NSColor, lineWidth: CGFloat, in context: CGContext) {
    ...
    public static func smoothPoints(_ points: [CGPoint]) -> [CGPoint] {
    ...
    public static func constrainToAngles(from start: CGPoint, to end: CGPoint) -> CGPoint {
    ...
    public static func rectFrom(start: CGPoint, end: CGPoint) -> CGRect {
